...
<div class="main-content">
    <div class="btn-toolbar list-toolbar">
        <table class="table table-striped table-condensed" cellspacing="0" cellpadding="0">
            <tr>
                <td>
                    <form class="form-inline" method="post" style="margin-top:0px; " action="?page=cari_nota">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        if ((isset($_POST['submit'])) && ($_POST['search'] !== "")) {
            ...
            $sql1 = $mysqli->query("SELECT * FROM pembayaran WHERE nama_siswa LIKE '%$search%'");

            $nomor = 0;

            while ($myData = $sql1->fetch_assoc()) {
                $nomor++;
                ?>
                <tr>
