...
header("Content-Disposition: attachment; filename=simpanbyrxls.xls"); // change the filename as needed
...
<div align="center">
    <h2>DATA TRANSAKSI PEMBAYARAN</h2><br />
    <div class="main-content">
        ...
        <table class="table table-striped table-bordered table-condensed">
            ...
            $myQry = mysqli_query($koneksidb, $mySql) or die("Gagal Query Tmp" . mysqli_error($koneksidb));
            $jumData = mysqli_num_rows($myQry);
            $nomor = 0;
